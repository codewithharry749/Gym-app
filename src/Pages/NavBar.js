                    ...
                    <div className="collapse navbar-collapse " id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto text-center mb-2 mb-lg-0 menu_items gap-2 ">
                            ...
                            <li className="nav-item">
                                ...
                                <a href='#about'>
                                    {/* <NavLink  className="nav-link active text-white" aria-current="page" to="/about"> */}
                                    ABOUT US
                                    {/* </NavLink> */}
                                </a>
                            </li>
                            <li className="nav-item">
                                {/* <NavLink className="nav-link active text-white" aria-current="page" to="/classes"> */}
                            ...
                            <li className="nav-item">
                                {/* <NavLink className="nav-link active text-white" aria-current="page" to="/schedule">  */}
                            ...
                            <li className="nav-item">
                                {/* <NavLink className="nav-link active text-white " to="/contact" tabindex="-1" > */}
                        ...
                        <form className="d-flex">
                            <ul style={{
                                ...
                                className='gap-4'
                            >
                                <li> <a target='_blank' href='https://www.facebook.com/profile.php?id=100023756560146'><i class="fa-brands fa-facebook f"></i></a></li>
                                <li><i class="fa-brands fa-x-twitter t"></i></li>
                                <li><a target='_blank' href='https://www.instagram.com/be_creative7238/'><i class="fa-brands fa-instagram i"></i></a></li>
                                <li style={{ color: 'white' }}><button type="button" class="btn btn-primary btn-sm">Signup</button></li>
                                <li style={{ color: 'white' }}><button type="button" class="btn btn-primary btn-sm">Logout</button></li>
                            </ul>
